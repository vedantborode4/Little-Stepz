...
export default function CartSummary() {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-card p-4 sm:p-6 h-fit space-y-4 sm:space-y-5 lg:sticky lg:top-6">
      ...
      <Link
        href="/checkout"
        className="flex items-center justify-center gap-2 w-full bg-primary text-white py-3 sm:py-3.5 rounded-xl font-semibold hover:opacity-90 transition shadow-sm text-sm sm:text-base"
      >
        Proceed to Checkout
        <ArrowRight size={16} />
      </Link>
