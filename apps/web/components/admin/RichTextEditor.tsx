...
function Toolbar({ editor }: { editor: Editor }) {
  return (
    <div className="flex flex-wrap items-center gap-1 border-b border-border px-2 py-1.5 bg-surface-2">
...
export default function RichTextEditor({ value, onChange }: Props) {
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: `min-h-[160px] px-3.5 py-3 text-sm text-muted focus:outline-none ${RICH_TEXT_CLASS}`,
      },
    },
  ...
  return (
    <div className="border border-border rounded-xl overflow-hidden bg-surface focus-within:ring-2 focus-within:ring-primary/20 transition">
