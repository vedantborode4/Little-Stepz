    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className="w-full border border-border rounded-xl px-3.5 py-2.5 text-sm pr-10 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition"
        />
        <button
          type="button"
          tabIndex={-1}
