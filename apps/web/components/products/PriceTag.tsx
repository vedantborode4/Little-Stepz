...
export default function PriceTag({ prices, size = "sm", className = "" }: Props) {
  ...
  const main = size === "lg" ? "font-anton text-3xl font-bold text-gray-900" : "font-anton text-primary font-semibold text-sm sm:text-base"
  const struck = size === "lg" ? "font-anton text-base text-gray-400 line-through" : "font-anton text-xs text-gray-400 line-through"
