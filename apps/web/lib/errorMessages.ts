...
const ERROR_COPY: Record<string, string> = {
  ...
  COD_NOT_AVAILABLE: "Cash on Delivery isn't available for this address — our courier can't collect payment there.",
  ...
  DEPOSIT_FORFEIT_CONFIRMATION_REQUIRED: "Cancelling forfeits your deposit — please confirm to continue.",
